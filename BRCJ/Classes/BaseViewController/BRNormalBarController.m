...
@interface BRNormalBarController ()<UITabBarControllerDelegate>
...
@implementation BRNormalBarController
...
- (void)initTheMember{
    ...
    self.reportItem = [[BRTabBarItem alloc]initWithFrame:CGRectMake(width, 0, width, 49)];
    ...
    self.schoolItem = [[BRTabBarItem alloc]initWithFrame:CGRectMake(width*2, 0, width, 49)];
    ...
    self.stockItem = [[BRTabBarItem alloc]initWithFrame:CGRectMake(width*3, 0, width, 49)];
    ...
    self.mineItem = [[BRTabBarItem alloc]initWithFrame:CGRectMake(width*4, 0, width, 49)];
...
- (void)initTheNoMember{
    ...
    self.schoolItem = [[BRTabBarItem alloc]initWithFrame:CGRectMake(width*1, 0, width, bottomHeight)];
    self.schoolItem.iconView.contentMode = UIViewContentModeScaleAspectFit;
    self.schoolItem.textView.text = @"学堂";
    [self.tabBar addSubview:self.schoolItem];
    
    self.stockItem = [[BRTabBarItem alloc]initWithFrame:CGRectMake(width*2, 0, width, bottomHeight)];
    self.stockItem.iconView.contentMode = UIViewContentModeScaleAspectFit;
    self.stockItem.textView.text = @"信息";
    [self.tabBar addSubview:self.stockItem];
    
    self.mineItem = [[BRTabBarItem alloc]initWithFrame:CGRectMake(width*3, 0, width, bottomHeight)];
    self.mineItem.iconView.contentMode = UIViewContentModeScaleAspectFit;
    self.mineItem.textView.text = @"我的";
    [self.tabBar addSubview:self.mineItem];
    if (self.currentNav == nil) {
